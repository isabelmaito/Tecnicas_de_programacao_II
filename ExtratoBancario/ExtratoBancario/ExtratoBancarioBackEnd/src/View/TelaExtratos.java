 ...
 * @author AlunosE
 */
public class TelaExtratos extends javax.swing.JFrame {
    ...
    public TelaExtratos(String operacaoAtiva){
        initComponents();
        ...
        if(operacaoAtiva.equals(operacao)){
            ...
            ID_histExtrato.setVisible(true);
        ...
        if(operacaoAtiva.equals(operacao)){
            ...
            ID_histExtrato.setVisible(true);
            AgenciaExtrato.setVisible(false);
            ContaExtrato.setVisible(false);
            DocExtrato.setVisible(false);
            DataExtrato.setVisible(false);     
            Credito_debitoExtrato.setVisible(false);
            ComplHistExtrato.setVisible(false);
            ValorExtrato.setVisible(false);
            SaldoExtrato.setVisible(false);
    ...
    private void ButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonCadastrarActionPerformed
        ...
        if(operacaoAtivaGlobal.equals(operacao)){       
            ...
            if(operacaoAtivaGlobal.equals(operacao) || operacaoAtivaGlobal.equals(operacaoExcluir)){
               ...
               this.SaldoExtrato.setText(String.valueOf(extrato_tela.getSaldo()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaExtratos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaExtratos().setVisible(true);
            }
        });
    }
